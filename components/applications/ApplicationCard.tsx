...
export function ApplicationCard({ application, formation, onChange, onRemove }: ApplicationCardProps) {
  ...
  const suggestion = documentSuggestionFor(formation.applicationProcedure);
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <ChecklistEditor
            ...
            onToggleRequired={(id) =>
              onChange({ ...application, documents: toggleChecklistItemRequired(application.documents, id) })
            }
            ...
            onAddSuggestion={
              suggestion
                ? () =>
                    onChange({
                      ...application,
                      documents: addSuggestedDocuments(application.documents, suggestion.items, suggestion.source),
                    })
                : undefined
            }
          />
        ...
        <div>
          ...
          <ChecklistEditor
            ...
            onToggleRequired={(id) =>
              onChange({ ...application, nextActions: toggleChecklistItemRequired(application.nextActions, id) })
            }
          />
        </div>
      </div>
