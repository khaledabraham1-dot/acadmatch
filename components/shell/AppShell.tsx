  ...
  return (
    <div className="flex h-full flex-col bg-slate-900 py-6">
      ...
      <div className="mx-4 mt-6 flex items-start gap-2.5 rounded-xl bg-white/5 p-3.5 text-xs text-slate-400">
        <FlaskConical className="size-4 shrink-0 text-slate-500" />
        <p>
          Prototype — les formations affichées sont des données de démonstration, pas des programmes officiels.
        </p>
      </div>
    </div>
  );
